...
// Server lists the color service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Update http.Handler
	Color  http.Handler
...
// New instantiates HTTP handlers for all the color service endpoints.
func New(
	e *color.Endpoints,
	mux goahttp.Muxer,
...
func (s *Server) Service() string { return "color" }
...
// Mount configures the mux to serve the color endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountUpdateHandler(mux, h.Update)
	MountColorHandler(mux, h.Color)
}

// MountUpdateHandler configures the mux to serve the "color" service "update"
// endpoint.
...
// calls the "color" service "update" endpoint.
func NewUpdateHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "color")
...
// MountColorHandler configures the mux to serve the "color" service "color"
// endpoint.
...
// calls the "color" service "color" endpoint.
